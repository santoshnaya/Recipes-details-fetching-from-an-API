      ...
      <div className="flex flex-wrap gap-4 mt-[30px] justify-center">
          {
              recipes.map((item) => {
                  return (
                      <div key={item.id} className="border-[1px] shadow-lg shadow-gray-300 border-blue-500 w-[300px] p-5 flex flex-col rounded-lg hover:scale-110 transition-all duration-150 ease-in-out hover:shadow-lg hover:shadow-gray-300 items-center text-center">
